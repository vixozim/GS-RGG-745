...
$okMessage = 'El mensaje fue enviado con correctamente, nos pondremos en contacto a la brevedad.';

// If something goes wrong, we will display this message.
$errorMessage = 'Ocurrio un error, por favor volver a probar mas tarde.';
